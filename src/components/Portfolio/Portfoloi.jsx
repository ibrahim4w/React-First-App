...
function Portfoloi() {
  return (
    <div className="text-center mx-auto mt-20 py-10 text-[#2c3e50] bg-white">
        <div className="py-5">
            <h2 className="font-bold text-3xl md:text-[40px] py-2 text-nowrap">PORTFOLIO COMPONENT</h2>
        ...
        <div className="w-[95%] md:w-[90%] mx-auto text-center grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
